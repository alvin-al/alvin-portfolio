...
const aboutMeText = (
  <p>
    {" "}
    Hi, Im Alvin, a passionate web developer from Temanggung, Indonesia. Im
    currently pursuing a degree in Information Systems at the Open University.{" "}
    <br />
    <br /> My interests span across design, technology, and web development, and
    Im always eager to learn and explore new things.
  </p>
);
