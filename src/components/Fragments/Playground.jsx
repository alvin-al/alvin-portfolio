...
const playgroundDescription = "My journey as a web developer started from graphic design. I have a passion for creating beautiful and functional websites that communicate effectively with the target audience. I have learned UI design and web development skills to deliver high-quality websites.";
...
const Playground = () => {
    return (
        <div id="playground">
            ...
            <p className="pt-4 pb-10 lg:pl-[55%]  xl:pl-[60%] xl:text-lg">{playgroundDescription}</p>
