...
const Hero = () => {
    return(
        <div className="flex flex-col justify-between h-[90vh] md:h-[96vh]" id="heroBanner" >
            ...
            <div id="heroBanner-name" className="flex flex-col ">
                <h1 className="font-syne font-extrabold text-6xl text-white text-center md:text-8xl md:text-left 2xl:text-[196px]">Alvin Al</h1>
