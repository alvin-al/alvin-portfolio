    ...
    return(
        <div id="playground">
            ...
            <div id="all-playground" className="grid box-border gap-4">
                ...
                <div className="flex flex-row align-top gap-4 h-60 border">
                ...
                <img src={DailydrivenBrosur} alt="" className="rounded-sm object-contain h-auto w-full"/>
                <img src={LaserPresisi} alt="" className="rounded-sm object-contain h-auto w-full"/>
            </div>
        </div>
    );
