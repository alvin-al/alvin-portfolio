...
function WorkSection (){
    return(
        <div id="work">
            ...
            <p className="text-left text-white text-base py-8 lg:pl-[55%]  xl:pl-[60%] xl:text-lg">As a web developer, I create websites that facilitate communication between businesses and their customers or clients. Websites are powerful tools that can enhance brand awareness, generate leads, and increase conversions. I use the latest technologies and best practices to design and develop websites that are user-friendly and responsive.</p>
