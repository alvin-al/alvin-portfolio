      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
        {blogs.map((post) => (
           <Link
            ...
            >
              <article className="flex flex-col h-full p-6 rounded-2xl border border-gray-400 hover:border-gray-900 hover:-translate-y-2 transition-all duration-300 ease-out relative overflow-hidden group-hover:shadow-2xl">
